...
glueSetLuaScript(group,"luaScript/Stage4/Group1.lua")
...
glueSetLuaScript(group2,"luaScript/Stage4/Group2.lua")
glueSetImage(group2,NormalEnemy)
glueSetInitPos(group2, 100.0,100.0)
glueSetSpeed(group2,0.2,0.2)
glueSetHP(group2,1)
...
glueSetBulletRate(group2,1.2)
glueSetBulletReflect(group2,true,2)
...
glueSetLuaScript(group3,"luaScript/Stage4/Group2.lua")
...
glueSetBulletRate(group3,1.5)
glueSetBulletReflect(group3,true,2)
